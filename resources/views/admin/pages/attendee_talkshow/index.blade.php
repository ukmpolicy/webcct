      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-lg-flex" style="justify-content: space-between; align-items:center;">
              <div class="d-flex align-items-center">
                <form action="" method="get" id="status">
                  ...
                  <a href="{{ route('talkshow.registration.export') }}" class="btn mb-2 btn-success"><i class="fa fa-file-export fa-fw"></i> Export</a>
                </form>
              </div>
